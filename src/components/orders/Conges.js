...
const Demandes = () => {
  ...
  // Solde de congés fixe
  const SOLDE_INITIAL = 21;
  ...
  const calculateRemainingDays = (dateDebut, dateFin) => {
    ...
    const daysTaken = timeDifference / (1000 * 3600 * 24);
    const daysRemaining = SOLDE_INITIAL - daysTaken; // Calcul des jours restants en soustrayant les jours pris du solde initial
